...
def create_cpu(options, cpu_id):
    ...
    # - FETCH STAGE
    # ****************************
    the_cpu.fetchWidth = 2*2 
    the_cpu.fetchBufferSize = 8*2
    the_cpu.fetchQueueSize = 8*2


    # ****************************
    # - DECODE STAGE
    # ****************************
    the_cpu.decodeWidth = 2*2
    

    # ****************************
    # - RENAME STAGE
    # ****************************
    the_cpu.numIQEntries = 4*2
    the_cpu.numROBEntries = 4*2
    the_cpu.renameWidth = 2*2


    # ****************************
    # - DISPATCH/ISSUE STAGE 
    # ****************************
    the_cpu.dispatchWidth = 2*2
    the_cpu.issueWidth = 2*2
    the_cpu.LQEntries = 8*2
    the_cpu.SQEntries = 8*2
    ...
    # - COMMIT STAGE  
    # ****************************
    the_cpu.commitWidth = 2*2
    the_cpu.squashWidth =  2*2
